...
class PlaneGame(pygame.sprite.Sprite, QObject):
    ...
    def __init__(self):
        ...
        enemy1_img = self.plane_img.subsurface(enemy1_rect)
        enemy1_down_imgs = []
        enemy1_down_imgs.append(self.plane_img.subsurface(pygame.Rect(267, 347, 57, 43)))
        enemy1_down_imgs.append(self.plane_img.subsurface(pygame.Rect(873, 697, 57, 43)))
        enemy1_down_imgs.append(self.plane_img.subsurface(pygame.Rect(267, 296, 57, 43)))
        enemy1_down_imgs.append(self.plane_img.subsurface(pygame.Rect(930, 697, 57, 43)))
